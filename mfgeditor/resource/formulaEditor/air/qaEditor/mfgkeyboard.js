            ...
            if ($(this).data("type") == 1) {
                ...
                switch ($(this).data("name")) {
                    case insertHtml.Table:
                        { 
                            $("#tableset").remove();
                            $(".fe-StyleWrp").append('<div id="tableset"><input id="cloumnNum" type="number" placeholder="列数"><label>列</label><br><input id="rowNum" type="number" placeholder="行数"><label>行</label><input type="button" value="确定" id="showTable">');
                    ...
                    case insertHtml.Image:
                        {
                            $("#imgurl").remove();
                            $(".fe-StyleWrp").append('<input id="imgurl" type="url" placeholder="请输入图片url"><input type="button" value="确定" id="showImg">');
