...
(function (e) {
    ...
    e.outplane = {
        ...
        addList: function (t) {
            ...
            if (document.activeElement != $("#textcell" + this.list[this.currentId])[0]) {
                return
            }
            this.id++;
            ...
            var p = $('<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;" style="vertical-align: bottom;" onpaste="editorCanvas.paste()" contentEditable="true"></td>"');
            p.insertAfter($("#textcell" + this.list[this.currentId]));
            var d = $("#textcell" + this.list[this.currentId - 1]);
            var v = $("#textcell" + this.list[this.currentId + 1]);
            d.focus();
        ...
        popList: function (t) {
            ...
            if (this.currentId > 0) {
                ...
                if (s == this.currentId) {
                    ...
                    var o = $("#textcell" + this.list[this.currentId]);
                    var u = $("#textcell" + this.list[this.currentId - 1]);
                    var a = u.closest(".editortablerow").attr("id").substring(14);
                    a = this.getRowListId(a);
                    o.html(u.html() + o.html());
                    ...
                    var d = $("#textcell" + p ).html();
                    //todo
                    var f = $("#textcell" + p ).text().length;
                    ...
                    $("#textcell" + p).focus();
                    setTimeout(function () {
                        e.outplane.setCursorPosition($("#textcell" + p)[0], f)
                    }, 0);
                    n.removeKeyboard();
                    $("#textcell" + p).trigger("keyup")
                }
                this.repairOffset();
                this.saveData()
            }
            ...
            if (this.currentId < n) {
                ...
                if (s.closest(".formulaOutplane").html() == $("#textcell" + this.list[this.currentId]).closest(".formulaOutplane").html()) {
                    if (s.attr("edittype") == "Text") {
                        $("#textcell" + i).focus();
                        setTimeout(function () {
                            e.outplane.setCursorPosition($("#textcell" + i)[0], 0)
                        }, 0);
                        t.removeKeyboard();
                        this.isCanvas = false
                    } else if (s.attr("edittype") == "Canvas") {
                        $("#textcell" + this.list[this.currentId]).blur();
            ...
            if (this.currentId > 0) {
                ...
                if (i.closest(".formulaOutplane").html() == $("#textcell" + this.list[this.currentId]).closest(".formulaOutplane").html()) {
                    if (i.attr("edittype") == "Text") {
                        ...
                        setTimeout(function () {
                            //todo
                            var t = $("#textcell" + r).text().length;
                            e.outplane.setCursorPosition($("#textcell" + r )[0], t)
                        }, 0);
                        t.removeKeyboard();
                        this.isCanvas = false
        ...
        addSign: function (t) {
            ...
            if (n.insertor.editCheck) {
                ...
                // i.value = o;
                // setTimeout(function () {
                //     e.outplane.setCursorPosition($("#textcell" + e.outplane.list[e.outplane.currentId])[0], s + t.length)
                // }, 0);
                this.repairInput($("#textcell" + r));
                this.saveData()
            }
        },
        addImg: function (t) {
            ...
            // var u = $('<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;">' + '<input type="text" class="celltext" style="width: 10px;" onpaste="editorCanvas.paste()">' + "</td>");
             var u = $('<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;" style="vertical-align: bottom;" onpaste="editorCanvas.paste()" contentEditable="true"></td>"');
            u.insertAfter($("#textcell" + this.list[this.currentId]));
            var a = $("#textcell" + this.list[this.currentId - 1]);
            var f = $("#textcell" + this.list[this.currentId + 1]);
            a.focus();
        ...
        newLine: function (t) {
            ...
            var r = $('<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;" style="vertical-align: bottom;" onpaste="editorCanvas.paste()" contentEditable="true"></td>"');
        ...
        for (var u = 0; u < o.length; u++) {
            ...
            for (var p = 0; p < h.length; p++) {
                ...
                // var d = '<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;">' + '<input type="text" class="celltext" style="width: 10px;" onpaste="editorCanvas.paste()">' + "</td>";
                 var d = $('<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;" onpaste="editorCanvas.paste()" contentEditable="true"></td>"');
                a.append(d);
    ...
    e.outplane.pasteToCell = function (n, r) {
        ...
        if (i.length > 1) {
            ...
            for (var l = 1; l < i.length; l++) {
                ...
                var h = $('<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;" style="vertical-align: bottom;" onpaste="editorCanvas.paste()" contentEditable="true"></td>"');
    ...
    e.creatFormulaOutplane = function (t) {
        ...
        var n = '<div class="editorTables">' + '<table class="editorTable">' + "<tbody>" + '<tr id="editortablerow' + e.outplane.rowID + '" class="editortablerow">' + '<td id="textcell' + e.outplane.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom; " contentEditable="true" onpaste="editorCanvas.paste()"></td>"' + '<td class="lastcell" style="width: 100%;">' + "</td>" + "</tr>" + "</tbody>" + "</table>" + "</div>" + '<div class="editorTablesEx"></div>';
        $(n).appendTo(t);
        ...
        for (var p = 0; p < h.length; p++) {
            ...
            for (var g = 0; g < m.length; g++) {
                if (a.test(m[g])) {
                    ...
                    var y = '<td id="textcell' + this.id + '" edittype="Text" nowrap="nowrap" editstate="true" style="vertical-align: bottom;" onpaste="editorCanvas.paste()" contentEditable="true">' + '' + "</td>";
                    v.append(y);
                    var b = m[g].replace(a, "$1");
                    $("#textcell" + this.id).html(b);
                    this.repairInput($("#textcell" + this.id));
                    this.currentId++
                } else if (u.test(m[g])) {
                    u.lastIndex = 0;
                    this.id++;
    ...
    e.activeFormulaZone = function (t, n) {
        ...
        $(n[0]).trigger("keydown").trigger("click")
    }
})(editorCanvas);
var Kibo = function (e) {
